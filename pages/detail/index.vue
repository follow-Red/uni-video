		...
		<scroll-view class="scrollBox">
			<view :class="summarStatu ? 'textMark' : ''">
				...
				<view class="summarybox">
					...
					<view class="summary">
						<template v-if="showText">
							{{summary}}
							<text v-if="summary !== null && summary.length > 85" class="full_text"
								@click="toggleDescription"></text>
						</template>
						<template v-else>
				...
				<view class="popular_comments" style="margin-top: 50rpx;">
					...
					<view class="popular_comments-page"
						style="width: 94%;margin: 14rpx auto;border-bottom: 1px solid rgba(204, 204, 204, .1);">
						<view class="commentsPage-t" style="display: flex; height: 100rpx;align-items: center">
							...
							<view
								style="display: flex;flex-direction: column;justify-content: space-around;height: 100rpx;">
								<text
									style="font-size: 30rpx;height: 30rpx;color: #fff;font-weight: 700;margin-left: 20rpx;">{{ popular_comments.author }}</text>
							</view>
						</view>
